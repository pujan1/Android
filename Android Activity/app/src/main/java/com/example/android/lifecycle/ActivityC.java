...
import static com.example.android.lifecycle.R.layout.activity_c;
/**
...
public class ActivityC extends Activity {
    ...
    protected void onResume() {
        ...
        Utils.printStatus(mStatusView, mStatusAllView);
        TextView DisplayText = (TextView) findViewById(R.id.count_3);
        count_C ++;
        DisplayText.setText(Integer.toString(count_C));
    }
